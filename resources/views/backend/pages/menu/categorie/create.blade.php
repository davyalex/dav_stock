                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="myModalLabel">Créer un nouvelle categorie </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                            </button>
                        </div>
                        <div class="modal-body">

                            <form class="row g-3 needs-validation" method="post" action="{{route('categorie-menu.store')}}" novalidate>
                                @csrf
                                <div class="col-md-8">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="statut" id="validationCustom02" required>
