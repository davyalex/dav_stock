<div class="row">
    <div class="col-xxl-6">
        <div class="card">
            <div class="modal fade" id="createComplementModal" tabindex="-1" aria-labelledby="createComplementModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="createComplementModalLabel">Créer un plat</h5>
