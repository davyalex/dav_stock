...
@section('content')
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($data_fournisseur as $key => $item)
                                    <tr id="row_{{ $item['id'] }}">
                                        <td> {{ ++$key }} </td>
                                        <td>
                                            <img class="rounded-circle"
                                                src="{{ $item->getFirstMediaUrl('fournisseurImage') }}" width="50px"
                                                alt="">
                                        </td>
                                        <td>{{ $item['nom'] }}</td>
                                    ...
                                    @include('backend.pages.fournisseur.edit')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
    ...
    @include('backend.pages.fournisseur.create')
@endsection
@section('script')
