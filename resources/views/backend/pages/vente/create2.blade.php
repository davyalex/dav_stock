                    ...
                    <select id="product-select" name="produit_id" class="form-select js-example-basic-single">
                        ...
                        @foreach ($data_produit as $produit)
                            <option value="{{ $produit->id }}"
                                data-price="{{ $produit->achats->first()->prix_vente_unitaire ?? $produit->prix }}">
                                {{ $produit->nom }} ({{ $produit->achats->first()->prix_vente_unitaire ?? $produit->prix }}
                                FCFA)
                            </option>
                        @endforeach
                    </select>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#validate-sale').click(function(e) {
                ...
                let montantRendu = parseFloat($('#change-amount').val() || 0);
