                                ...
                                <div class="row">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-lg-4">
                                            ...
                                            <div class="mt-2">
                                                <img id="background-preview" src="{{ $data_setting ? URL::asset($data_setting->getFirstMediaUrl('cover')) : URL::asset('build/images/profile-bg.jpg') }}" class="rounded-circle avatar-xl img-thumbnail" alt="Aperçu de l'arrière-plan">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="mt-2 text-center">
                                                <img id="header-preview" src="{{ $data_setting ? URL::asset($data_setting->getFirstMediaUrl('logo_header')) : URL::asset('images/avatar-1.jpg') }}" class="rounded-circle avatar-xl img-thumbnail" alt="Aperçu du logo d'en-tête">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="mt-2 text-center">
                                                <img id="footer-preview" src="{{ $data_setting ? URL::asset($data_setting->getFirstMediaUrl('logo_footer')) : URL::asset('images/avatar-1.jpg') }}" class="rounded-circle avatar-xl img-thumbnail" alt="Aperçu du logo de pied de page">
                                            </div>
                                        </div>
                                    </div>
