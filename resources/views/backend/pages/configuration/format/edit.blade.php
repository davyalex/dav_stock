     ...
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <form class="row g-3 needs-validation" method="post" action="{{ route('format.update', $item['id']) }}"
                     novalidate>
                     @csrf
                     <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                        ...
                        <input type="text" name="abreviation" value="{{ $item['abreviation'] }}" class="form-control"
                            id="validationCustom01" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
