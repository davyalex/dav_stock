    ...
    <div class="col-md-12">
        ...
        <div class="m-3 ">
            <?php if($categorie->children->isNotEmpty()): ?>
                <?php echo $__env->make('backend.pages.menu.produit.partials.categorieProduct', [
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\laragon\www\restaurant\resources\views/backend/pages/menu/produit/partials/categorieProduct.blade.php ENDPATH**/ ?>