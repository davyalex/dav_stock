    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3 needs-validation" method="post" action="<?php echo e(route('menu.add-item-store')); ?>" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="col-md-12">
                            <label for="validationCustom01" class="form-label">Menu principal </label>
                            <input readonly type="text" name="menu_parent" value="<?php echo e($data_menu_parent['name']); ?>" class="form-control" id="validationCustom01"
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\admin\Laravel\master\resources\views/backend/pages/menu/menu-item.blade.php ENDPATH**/ ?>