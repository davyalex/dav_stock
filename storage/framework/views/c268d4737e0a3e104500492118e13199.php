                ...
                <div class="main-menu">
                    <nav>
                        <ul>
                            ...
                            <?php $__currentLoopData = $menu_link; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="top-hover">
                                    <a href="blog-rightsidebar.html"><?php echo e($item['name']); ?>

                                        <?php if($item->children->isNotEmpty()): ?>
                                            <?php echo $__env->make('site.layouts.menu', [
                                                'menu_link' => $item->children,
...
<?php /**PATH C:\laragon\www\restaurant\resources\views/site/layouts/menu.blade.php ENDPATH**/ ?>