                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="row g-3 needs-validation" method="post"
                                action="<?php echo e(route('categorie-depense.store')); ?>" novalidate>
                                <?php echo csrf_field(); ?>
                                <div class="col-md-12">
...
<?php /**PATH C:\laragon\www\restaurant\Restaurant-chez-jeanne\resources\views/backend/pages/depense/categorie-depense/create.blade.php ENDPATH**/ ?>