                ...
                if (numero && fournisseur) { // Assurez-vous que les deux champs ne sont pas vides
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            _token: '<?php echo e(csrf_token()); ?>' // Ajoutez le token CSRF nécessaire
                        },
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\restaurant\Restaurant-chez-jeanne\resources\views/backend/pages/stock/achat/create.blade.php ENDPATH**/ ?>