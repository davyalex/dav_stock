                ...
                <div class="header-middle-right d-flex justify-content-end">
                    ...
                    <div class="header-cart">
                        <a href="<?php echo e(route('panier')); ?>">
                            ...
                            <span style="position: absolute; top: -15px; right: 80px;" class="count-style totalQuantity text-white"><?php echo e(session('cart') ? Session::get('totalQuantity') : '0'); ?></span>
                            <span style="margin-left: 10px" class="cart-digit-bold totalPrice text-white "><?php echo e(session('cart') ? Session::get('totalPrice') : '0'); ?> FCFA</span>
                        </a>
                    </div>
                </div>
            </div>
