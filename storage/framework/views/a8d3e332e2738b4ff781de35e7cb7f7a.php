    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3 needs-validation" method="post" action="<?php echo e(route('menu.update' , $data_menu_edit['id'])); ?>" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="col-md-12">
                            <label for="validationCustom01" class="form-label">Menu principal </label>
                            <input type="text" name="name" value="<?php echo e($data_menu_edit['name']); ?>"
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="status" class="form-control">
                                ...
                                <option value="desactive" <?php echo e($data_menu_edit['status'] == 'desactive' ? 'selected' : ''); ?>>Desactivé
                                </option>
                            </select>
                            <div class="valid-feedback">
                                Looks good!
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\admin\Laravel\master\resources\views/backend/pages/menu/menu-edit.blade.php ENDPATH**/ ?>