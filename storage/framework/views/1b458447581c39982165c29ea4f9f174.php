     ...
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <form class="row g-3 needs-validation" method="post" action="<?php echo e(route('format.update', $item['id'])); ?>"
                     novalidate>
                     <?php echo csrf_field(); ?>
                     <div class="col-md-12">
...
<?php /**PATH /home1/maxisgwd/restaurant.maxisujets.net/resources/views/backend/pages/configuration/format/edit.blade.php ENDPATH**/ ?>