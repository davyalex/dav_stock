            ...
            <div class="card">
                <div class="card-body">
                    <form class="row g-3 needs-validation" method="post"
                        action="<?php echo e(route('blog-content.update', $data_blog_content['id'])); ?>" novalidate enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-1">
                            <img src="<?php echo e(asset($data_blog_content->getFirstMediaUrl('blogImage'))); ?>" alt="" width="50">
                        </div>
                            ...
                            <select name="category" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $data_blog_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item['id']); ?>"
                                        <?php echo e($data_blog_content['blog_categories_id'] == $item['id'] ? 'selected' : ''); ?>><?php echo e($item['name']); ?>
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="status" class="form-control">
                                ...
                                <option value="desactive" <?php echo e($data_blog_content['status'] == 'desactive' ? 'selected' : ''); ?>>Desactivé
                                </option>
                            </select>
                            <div class="valid-feedback">
                                Looks good!
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\admin\Laravel\master\resources\views/backend/pages/blog/content/edit.blade.php ENDPATH**/ ?>