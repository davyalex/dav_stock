         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <form class="row g-3 needs-validation" method="post"
                     action="<?php echo e(route('categorie-depense.position', $item['id'])); ?>" novalidate>
                     <?php echo csrf_field(); ?>
                     ...
                     <div class="col-md-12">
                         ...
                         <select name="position" class="form-control">
                             <?php for($i = 1; $i <= count($data_categorie_depense); $i++): ?>
...
<?php /**PATH C:\laragon\www\restaurant\Restaurant-chez-jeanne\resources\views/backend/pages/depense/categorie-depense/position.blade.php ENDPATH**/ ?>