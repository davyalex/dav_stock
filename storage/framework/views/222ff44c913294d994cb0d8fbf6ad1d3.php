                    ...
                    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data_depense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="row_<?php echo e($item['id']); ?>">
                                    ...
                                    <td><?php echo e(number_format($item['montant'], 2, ',', ' ')); ?></td>
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item edit-item-btn" href="#" data-bs-toggle="modal" data-bs-target="#myModalEdit<?php echo e($item['id']); ?>">
                                                        <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Modifier
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item remove-item-btn delete" href="#" data-id="<?php echo e($item['id']); ?>">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><?php echo e(number_format($data_depense->sum('montant'), 2, ',', ' ')); ?></th>
                                <th colspan="3"></th>
                            </tr>
                        </tfoot>
                    </table>
