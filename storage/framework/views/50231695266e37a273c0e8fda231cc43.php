     ...
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <form class="row g-3 needs-validation" method="post" action="<?php echo e(route('unite.update', $item['id'])); ?>"
                     novalidate>
                     <?php echo csrf_field(); ?>
                     <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                        ...
                        <input type="text" name="abreviation" value="<?php echo e($item['abreviation']); ?>" class="form-control"
                            id="validationCustom01" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
...
<?php /**PATH C:\laragon\www\restaurant\Restaurant-chez-jeanne\resources\views/backend/pages/configuration/unite-de-mesure/edit.blade.php ENDPATH**/ ?>