...
<option <?php echo e($category->type =='plats' ? 'disabled' : ''); ?>  value="<?php echo e($category->id); ?>" <?php echo e($data_plat['categorie_id'] == $category->id ? 'selected' :''); ?>><?php echo e(str_repeat('--', $level ?? 0)); ?> <?php echo e($category->name); ?></option>
