     ...
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <form class="row g-3 needs-validation" method="post" action="<?php echo e(route('caisse.update', $item['id'])); ?>"
                     novalidate>
                     <?php echo csrf_field(); ?>
                     <div class="col-md-12">
...
<?php /**PATH C:\laragon\www\restaurant\Restaurant-chez-jeanne\resources\views/backend/pages/configuration/caisse/edit.blade.php ENDPATH**/ ?>