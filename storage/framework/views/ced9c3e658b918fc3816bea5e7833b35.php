                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate method="POST"
                                action="<?php echo e(route('client.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
...
<?php /**PATH C:\laragon\www\restaurant\resources\views/backend/pages/auth-client/create.blade.php ENDPATH**/ ?>