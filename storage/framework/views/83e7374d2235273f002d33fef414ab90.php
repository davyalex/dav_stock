        ...
        <li>
            <?php if($categorie->children->isNotEmpty()): ?>
                <a data-bs-toggle="collapse" data-bs-parent="#faq" href="#shop-categorie-<?php echo e($categorie->id); ?>"
                    class="text-danger <?php echo e(isset($categorieSelect) && $categorie->famille == $categorieSelect->famille ? 'show' : 'collapsed'); ?>"
                    aria-expanded="<?php echo e(isset($categorieSelect) && $categorie->famille == $categorieSelect->famille ? 'true' : 'false'); ?>">
                    <strong class="fs-6">
                ...
                <ul id="shop-categorie-<?php echo e($categorie->id); ?>"
                    class="panel-collapse collapse <?php echo e(isset($categorieSelect) && $categorie->famille == $categorieSelect->famille ? 'show' : ''); ?>">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('produit', $categorie->id)); ?>"
                    class="<?php echo e(isset($categorieSelect) && $categorie->id == $categorieSelect->id ? 'fw-bold' : ''); ?>">
                    <?php if($categorie->slug === 'bar'): ?>
                        Boissons
                    <?php elseif($categorie->slug === 'cuisine-interne'): ?>
                        Restaurant
