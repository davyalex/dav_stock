            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="product-details-img">
                        <img class="zoompro" src="<?php echo e($produit->getFirstMediaUrl('ProduitImage')); ?>"
                            data-zoom-image="<?php echo e($produit->getFirstMediaUrl('ProduitImage')); ?>" width="10px" alt="<?php echo e($produit->nom); ?>" />
                        <div id="gallery" class="mt-20 product-dec-slider owl-carousel">
                            <?php $__currentLoopData = $produit->getMedia('galleryProduit'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a data-image="<?php echo e($media->getUrl()); ?>"
                                    data-zoom-image="<?php echo e($media->getUrl()); ?>>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="product-details-content">
                        ...
                        <span> <?php echo e($produit->achats->isNotEmpty() ? $produit->achats[0]->prix_vente_unitaire : $produit->prix); ?> FCFA </span>
