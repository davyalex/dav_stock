...
<?php $__env->startSection('script'); ?>
    ...
    //         `;
        ...
        //             <p style="text-align: center; font-size: 10px;">Code : <?php echo e($inventaire->code); ?></p>
        //             <p style="text-align: center; font-size: 10px;">Réalisé le : <?php echo e($inventaire->created_at->format('d-m-Y à H:i')); ?></p>
        //             ${$('.divPrint').html()}
        //             <footer>
