        ...
        <script>
            ...
            $('.typeSelected').change(function(e) {
                ...
                if (filterType[0].name == 'bar') {
                    var barForm = ` <?php echo $__env->make('backend.pages.produit.entree.barProduct', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>`
                    $('#entree').html(barForm)
                } else if (filterType[0].name == 'restaurant') {
                    var restaurantForm = ` <?php echo $__env->make('backend.pages.produit.entree.restaurantProduct', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>`
