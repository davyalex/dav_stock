                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="footer-about mb-40">
                            <div class="footer-logo">
                                <a href="#">
                                    <img src="<?php echo e($setting->getFirstMediaUrl('logo_footer') ?? 'assets/img/logo/footer-logo.png'); ?>" width="50" alt="">
                                </a>
                            </div>
                            <p> <?php echo e($setting->projet_description ?? 'Bienvenue chez restaurant Jeanne!'); ?> </p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="footer-widget mb-40">
                            ...
                            <div class="footer-contact">
                                <ul>
                                    <li>Localisation: <?php echo e($setting->localisation ?? '123 Main Your address goes here.'); ?></li>
                            ...
                            <div class="footer-time">
                                <ul>
                                    <li>Ouverture: <span><?php echo e($setting->horaire_ouverture ?? '8:00 AM'); ?></span> - Close: <span><?php echo e($setting->horaire_fermeture ?? '18:00 PM'); ?></span></li>
                                    <li>Lundi - Dimanche: <span><?php echo e($setting->horaire_weekend ?? 'Close'); ?></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-7">
                        <div class="copyright">
                            <p>&copy; <?php echo e(date('Y')); ?> <strong> <?php echo e($setting->projet_title ?? 'Restaurant Jeanne'); ?> </strong> Made with <i class="fa fa-heart text-danger"></i>
    ...
    <!-- all js here -->
 <?php echo $__env->make('site.layouts.vendor-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\restaurant\Restaurant-chez-jeanne\resources\views/site/layouts/footer.blade.php ENDPATH**/ ?>