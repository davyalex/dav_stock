                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-3 mb-3 d-none">
                                                ...
                                                <input type="text" id="quantiteStocke" class="form-control"
                                                    value="<?php echo e($data_ajustement['quantite_stocke']); ?>" readonly>
                                            </div>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/maxisgwd/restaurant.maxisujets.net/resources/views/backend/pages/stock/ajustement/create.blade.php ENDPATH**/ ?>