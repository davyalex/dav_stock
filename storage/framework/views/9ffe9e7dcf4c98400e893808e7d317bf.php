    ...
    <div class="col-md-12">
        ...
        <?php $__currentLoopData = $categorie->produit_menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="form-check form-check-dark m-2 ">
                <input class="form-check-input fs-3 produit" value="<?php echo e($produit['id']); ?>" name="produits[]" type="checkbox"
        ...
        <div class="m-3 ">
            <?php if($categorie->children->isNotEmpty()): ?>
                <?php echo $__env->make('backend.pages.menu.produit.partials.categorieProductEdit', [
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\laragon\www\restaurant\resources\views/backend/pages/menu/produit/partials/categorieProductEdit.blade.php ENDPATH**/ ?>