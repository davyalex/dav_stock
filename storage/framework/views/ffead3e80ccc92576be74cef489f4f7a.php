                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="caisse_id" name="caisse_id">
                                        ...
                                        <?php $__currentLoopData = $caisses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $caisse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($caisse->id); ?>" <?php echo e(request('caisse_id') == $caisse->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="categorie" name="categorie_famille">
                                    ...
                                    <?php $__currentLoopData = $famille; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->famille); ?>" <?php echo e(request('categorie_famille') == $item->famille ? 'selected' : ''); ?>>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card divPrint">
                ...
                <div class="card-body">
                    <?php $__currentLoopData = $produitsVendus->groupBy('famille'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $famille => $produits): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <h3>
                            <?php if($famille == 'bar'): ?>
                            Boissons
                        <?php elseif($famille == 'menu'): ?> 
                            Cuisine interne
                        <?php else: ?>
                            <?php echo e($famille); ?>
                    ...
                    <div class="mt-4">
                        ...
                        <p>Montant total des ventes : <?php echo e(number_format($produitsVendus->sum('montant_total'), 0, ',', ' ')); ?> FCFA</p>
                    </div>
                </div>
            </div>
