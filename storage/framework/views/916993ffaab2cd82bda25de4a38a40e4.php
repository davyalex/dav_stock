                ...
                <div class="card-body">
                    <form id="formSend" autocomplete="off" class="needs-validation" novalidate enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card">
                                    <a href="<?php echo e(route('produit.create')); ?>" class="float-end text-decoration-underline">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\restaurant\resources\views/backend/pages/produit/partials/createProduct.blade.php ENDPATH**/ ?>