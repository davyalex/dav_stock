<?php $__currentLoopData = $data_categorie_produit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-md-12">
        <?php
            $dNone = $categorie->produits->isEmpty() && $categorie->type != 'plats' && $categorie->children->isEmpty() ? 'd-none' : '';
            $textUpper = in_array($categorie->type , ['plats', 'boissons']) ? 'text-uppercase alert alert-primary alert-border-left fs-4 mt-4' : 'text-capitalize fw-bold';
        ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\laragon\www\Restaurant-NEUILLY-\resources\views/backend/pages/menu/partials/categorieProduct.blade.php ENDPATH**/ ?>