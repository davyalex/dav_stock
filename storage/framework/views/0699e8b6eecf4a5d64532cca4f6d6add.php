                ...
                <div class="card-body">
                    <form class="row g-3 needs-validation" method="post"
                        ...
                        <div class="col-md-10">
                            ...
                            <input type="text" name="name" value="<?php echo e($data_categorie_edit['name']); ?>"
                            ...
                            <select name="position" class="form-control">
                                <?php for($i = 1; $i <= $data_count; $i++): ?>
                                    <option value="<?php echo e($i); ?>"
                                        <?php echo e($data_categorie_edit['position'] == $i ? 'selected' : ''); ?>>
                                        <?php echo e($i); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="status" class="form-control">
                                ...
                                <option value="desactive"
                                    <?php echo e($data_categorie_edit['status'] == 'desactive' ? 'selected' : ''); ?>>
                                    Desactivé
                                </option>
                            </select>
                            <div class="valid-feedback">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\restaurant\Restaurant-chez-jeanne\resources\views/backend/pages/categorie/categorie-edit.blade.php ENDPATH**/ ?>