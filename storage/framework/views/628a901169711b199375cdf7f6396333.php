                        ...
                        <div class="tab-content jump yellow-color">
                            ...
                            <div id="tab2" class="tab-pane">
                                ...
                                <div class="col-12 col-md-6 col-lg-6  m-auto text-center mt-5">
                                    <a href="<?php echo e(route('produit', $idCatBoisson->id)); ?>"
                                        ...
                                        <div class="col-lg-3 col-md-3 col-6">
                                            <div class="product-wrapper">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <div class="product-price-wrapper">
                                                        <span id="price" data-price=<?php echo e($produit->prix); ?>>
                                                            <?php echo e(number_format($produit->prix, 0, ',', ' ')); ?> FCFA</span>
                                                    </div>
                                    ...
                                    <div class="product-wrapper">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <div class="product-price-wrapper">
                                                ...
                                                <span id="price"
                                                    data-price=<?php echo e($produit->prix); ?>><?php echo e(number_format($produit->prix, 0, ',', ' ')); ?>
