...
// Profile Foreground Img
if (document.querySelector("#profile-img-file-input-header")) {
    document
        .querySelector("#profile-img-file-input-header")
        .addEventListener("change", function () {
            var preview = document.querySelector(".user-profile-image-header");
            var file = document.querySelector(".profile-img-file-input-header")
                .files[0];
...
if (document.querySelector("#profile-img-file-input-footer")) {
    document
        .querySelector("#profile-img-file-input-footer")
        .addEventListener("change", function () {
            var preview = document.querySelector(".user-profile-image-footer");
            var file = document.querySelector(".profile-img-file-input-footer")
                .files[0];
            var reader = new FileReader();
            reader.addEventListener(
                "load",
